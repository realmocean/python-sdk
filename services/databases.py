...
class Databases(Service):
    ...
    def create(self, database_id, name, enabled = None):
        ...
        if database_id is None:
            raise RealmoceanException('Missing required parameter: "database_id"')
    ...
    def create_collection(self, database_id, collection_id, name, permissions = None, document_security = None, enabled = None):
        ...
        if collection_id is None:
            raise RealmoceanException('Missing required parameter: "collection_id"')
    ...
    def create_boolean_attribute(self, database_id, collection_id, key, required, default = None, array = None):
        ...
        if key is None:
            raise RealmoceanException('Missing required parameter: "key"')

        if required is None:
            raise RealmoceanException('Missing required parameter: "required"')
    ...
    def create_enum_attribute(self, database_id, collection_id, key, elements, required, default = None, array = None):
        ...
        if elements is None:
            raise RealmoceanException('Missing required parameter: "elements"')
    ...
    def update_float_attribute(self, database_id, collection_id, key, required, min, max, default):
        ...
        if min is None:
            raise RealmoceanException('Missing required parameter: "min"')

        if max is None:
            raise RealmoceanException('Missing required parameter: "max"')
    ...
    def create_relationship_attribute(self, database_id, collection_id, related_collection_id, type, two_way = None, key = None, two_way_key = None, on_delete = None):
        ...
        if related_collection_id is None:
            raise RealmoceanException('Missing required parameter: "related_collection_id"')

        if type is None:
            raise RealmoceanException('Missing required parameter: "type"')
    ...
    def create_string_attribute(self, database_id, collection_id, key, size, required, default = None, array = None, encrypt = None):
        ...
        if size is None:
            raise RealmoceanException('Missing required parameter: "size"')
    ...
    def create_document(self, database_id, collection_id, document_id, data, permissions = None):
        ...
        if document_id is None:
            raise RealmoceanException('Missing required parameter: "document_id"')

        if data is None:
            raise RealmoceanException('Missing required parameter: "data"')
    ...
    def create_index(self, database_id, collection_id, key, type, attributes, orders = None):
        ...
        if attributes is None:
            raise RealmoceanException('Missing required parameter: "attributes"')
