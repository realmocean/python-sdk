...
class Account(Service):
    ...
    def update_phone(self, phone, password):
        ...
        api_params = {}
        if phone is None:
            raise RealmoceanException('Missing required parameter: "phone"')
    ...
    def create_recovery(self, email, url):
        ...
        if url is None:
            raise RealmoceanException('Missing required parameter: "url"')
    ...
    def update_recovery(self, user_id, secret, password, password_again):
        ...
        if password_again is None:
            raise RealmoceanException('Missing required parameter: "password_again"')
