...
class Teams(Service):
    ...
    def create(self, team_id, name, roles = None):
        ...
        api_params = {}
        if team_id is None:
            raise RealmoceanException('Missing required parameter: "team_id"')
    ...
    def create_membership(self, team_id, roles, email = None, user_id = None, phone = None, url = None, name = None):
        ...
        if roles is None:
            raise RealmoceanException('Missing required parameter: "roles"')
    ...
    def get_membership(self, team_id, membership_id):
        ...
        if membership_id is None:
            raise RealmoceanException('Missing required parameter: "membership_id"')
    ...
    def update_membership_status(self, team_id, membership_id, user_id, secret):
        ...
        if secret is None:
            raise RealmoceanException('Missing required parameter: "secret"')
