...
class Functions(Service):
    ...
    def create(self, function_id, name, runtime, execute = None, events = None, schedule = None, timeout = None, enabled = None, logging = None, entrypoint = None, commands = None, installation_id = None, provider_repository_id = None, provider_branch = None, provider_silent_mode = None, provider_root_directory = None, template_repository = None, template_owner = None, template_root_directory = None, template_branch = None):
        ...
        if function_id is None:
            raise RealmoceanException('Missing required parameter: "function_id"')

        if name is None:
            raise RealmoceanException('Missing required parameter: "name"')

        if runtime is None:
            raise RealmoceanException('Missing required parameter: "runtime"')
    ...
    def create_deployment(self, function_id, code, activate, entrypoint = None, commands = None, on_progress = None):
        ...
        if code is None:
            raise RealmoceanException('Missing required parameter: "code"')

        if activate is None:
            raise RealmoceanException('Missing required parameter: "activate"')
    ...
    def get_deployment(self, function_id, deployment_id):
        ...
        if deployment_id is None:
            raise RealmoceanException('Missing required parameter: "deployment_id"')
    ...
    def create_build(self, function_id, deployment_id, build_id):
        ...
        if build_id is None:
            raise RealmoceanException('Missing required parameter: "build_id"')
    ...
    def get_execution(self, function_id, execution_id):
        ...
        if execution_id is None:
            raise RealmoceanException('Missing required parameter: "execution_id"')
    ...
    def create_variable(self, function_id, key, value):
        ...
        if value is None:
            raise RealmoceanException('Missing required parameter: "value"')
    ...
    def get_variable(self, function_id, variable_id):
        ...
        if variable_id is None:
            raise RealmoceanException('Missing required parameter: "variable_id"')
